      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/services" className="text-white/60 hover:text-purple-400 transition-colors text-sm">
                  Web Development
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              <li>
                <a 
                  href="mailto:contact@igniai.com" 
              ...
              <li>
                <a 
                  href="https://linkedin.com/company/igniai" 
                  target="_blank"
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/60 text-sm">
            © 2026 IgniAI Technologies. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link href="/privacy" className="text-white/60 hover:text-purple-400 transition-colors text-sm">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-white/60 hover:text-purple-400 transition-colors text-sm">
              Terms of Service
            </Link>
          </div>
        </div>
